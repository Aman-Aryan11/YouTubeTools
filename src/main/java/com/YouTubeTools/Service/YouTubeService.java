...
public class YouTubeService {
    ...
    public SearchVideo searchVideos(String videoTitle) {
        ...
        List<String> relatedVideoIds = videoIds.subList(1, Math.min(videoIds.size(), 1 + maxRelatedVideos));
    ...
    public VideoDetails getVideoDetails(String videoId) {
        ...
        Snippet snippet = response.items.getFirst().snippet;
    ...
    private Video getVideoById(String videoId) {
        ...
        Snippet snippet = response.items.getFirst().snippet;
        String thumbnailUrl = snippet.thumbnails != null ? snippet.thumbnails.getBestThumbnailUrl() : "";
